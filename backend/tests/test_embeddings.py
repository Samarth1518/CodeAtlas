"""
tests/test_embeddings.py — Unit tests for services/embeddings.py
"""
...
class EmbeddingsServiceTestCase(unittest.TestCase):
    def setUp(self):
        # Create a mock model to avoid downloading weights during test runs
    ...
    def test_model_error_raises_runtime_error(self):
        self.mock_model.encode.side_effect = RuntimeError("Inference failed.")
